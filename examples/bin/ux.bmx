...
Type UX
	...
	Function Init()
		_colours_ = [ ..
		New SColor8( $6200EE ),		' PRIMARY
		New SColor8( $6200EE ),		' PRIMARY VARIANT
		New SColor8( $6200EE ),		' SECONDARY
		New SColor8( $6200EE ),		' SECONDARY VARIANT
		New SColor8( $404040 ),		' BACKGROUND
		New SColor8( $404040 ),		' SURFACE
		New SColor8( $404040 ),		' ERROR
		BLACK,						' ON PRIMARY
		BLACK,						' ON PRIMARY VARIANT
		WHITE,						' ON SECONDARY
...
?
	...
	Function Button:Int( id:Int, Caption:String, x:Int, y:Int, w:Int = -1, h:Int = -1, flags:Int = 0 )
		...
		Else
			BG = _colours_[ COL_PRIMARY ]
			FG = _colours_[ COL_ONPRIMARY ]		
		End If
