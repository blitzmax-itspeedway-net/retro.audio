...
Repeat
	...
	If UX.OnOffButton( BTN_SFXR_COIN, "PICKUP/COIN", buttongroup, 5, 5, 102, 19 ) ; DoSound( SFXR_COIN, "SFXR_COIN" )
	If UX.OnOffButton( 2, "LASER/SHOOT", buttongroup, 5, 30, 102, 19 ) ; DoSound( SFXR_LASER, "SFXR_SHOOT" )
	If UX.OnOffButton( 3, "EXPLOSION", buttongroup, 5, 55, 102, 19 ) ; DoSound( SFXR_EXPLOSION, "SFXR_EXPLOSION" )
	If UX.OnOffButton( 4, "POWERUP", buttongroup, 5, 80, 102, 19 ) ; DoSound( SFXR_POWERUP, "SFXR_POWERUP" )
	If UX.OnOffButton( 5, "HIT/HURT", buttongroup, 5, 105, 102, 19 ) ; DoSound( SFXR_HIT, "SFXR_HIT" )
	If UX.OnOffButton( 6, "JUMP", buttongroup, 5, 130, 102, 19 ) ; DoSound( SFXR_JUMP, "SFXR_JUMP" )
	If UX.OnOffButton( 7, "BLIP/SELECT", buttongroup, 5, 155, 102, 19 ) ; DoSound( SFXR_BLIP, "SFXR_BLIP" )
